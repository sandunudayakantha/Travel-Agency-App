          ...
          <div className="bg-white rounded-lg shadow-sm p-8 md:p-12">
            ...
            >
              ...
              <p className="text-gray-700 mb-8">
                These Terms of Service ("Terms") govern your use of our website and services operated by our Travel Agency ("we," "us," or "our").
              </p>
              ...
              <p className="text-gray-700 mb-4">You may use our services only for lawful purposes and in accordance with these Terms. You agree not to use the services:</p>
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Booking Process</h3>
              <p className="text-gray-700 mb-4">When making a booking through our services:</p>
              <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
              ...
              <p className="text-gray-700 mb-4">Payment requirements and terms:</p>
              <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
              ...
              <p className="text-gray-700 mb-4">Our cancellation policy is as follows:</p>
              <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
              ...
              <p className="text-gray-700 mb-4">It is your responsibility to:</p>
              <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
              ...
              <p className="text-gray-700 mb-4">Our pricing policy includes:</p>
              <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Service Changes</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Customer Changes</h3>
              <p className="text-gray-700 mb-4">Modification requests:</p>
              <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
              ...
              <p className="text-gray-700 mb-4">Our liability is limited as follows:</p>
              <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
              ...
              <p className="text-gray-700 mb-4">In the event of a dispute:</p>
              <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-700 mb-2">
                  <strong>Email:</strong> legal@travelagency.com
                </p>
                <p className="text-gray-700 mb-2">
                ...
                <p className="text-gray-700">
                  <strong>Legal Department:</strong> legal@travelagency.com
                </p>
              </div>
